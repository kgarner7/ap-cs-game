...
public interface Grid<E>
{
    ...
    /**
     * Gets all the empty locations in the grid
     * @return an arraylist containing all the empty locations in the grid
     */
    ArrayList<Location> getEmptyLocations();
    
    /**
     * Gets the User in the grid
     * @return the User in the grid
     */
    User getUser();
    
    /**
     * Gets the Stairs in the grid
     * @return the Stairs in the grid
     */
    Stairs getStairs();
}
