...
public class WorldFrame<T> extends JFrame
{
     ...
     */
    @SuppressWarnings("rawtypes")
	public WorldFrame(World<T> world, double factor)
    {
        ...
        display = new GridPanel(displayMap, resources,factor);
        ...
        control = new GUIController<T>(this, display, displayMap, resources, factor);
    ...
    /**
     * returns the frame's GUI
     * @return control the GUI used
     */
    ...
    public void zoom()
    {
    	if(world.getGrid().getUser() != null)
    		display.recenter(world.getGrid().getUser().getLocation());
    }
