...
public class World<T>
{
    ...
    /**
     * Constructs and shows a frame for this world and sets the difficulty level.
     * @param factor the difficulty factor
     */
    public void show(double factor)
    {
        if (frame == null)
        {
            frame = new WorldFrame<T>(this, factor);
    ...
    /**
     * returns the frame used for this world
     * @return frame the frame for the object
     */
